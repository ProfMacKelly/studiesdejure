...
Here’s how courts **[adjudicate](#)** disputes.

<span class="glossary">
  <input class="md-toggle" data-md-component="gloss" id="gloss-adjudicate" type="checkbox">
  <label class="glossary__term" for="gloss-adjudicate">adjudicate</label>
  <span class="glossary__tooltip">Issue decisions</span>
</span>
Laws are fun.
*[Laws]: Judicial Learning Center
