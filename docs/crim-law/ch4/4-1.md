...
Recall from [Chapter 1](../ch1/index.md) that not all crimes require a bad result, such as harm. If a crime does require a bad result, the prosecution must also prove the additional elements of causation and harm.
